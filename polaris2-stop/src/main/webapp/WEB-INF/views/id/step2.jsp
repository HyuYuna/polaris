...
<%
    ...
    String sSiteCode				= "FO56";			// NICE평가정보에서 발급한 IPIN 서비스 사이트코드
    String sSitePw					= "85091881";			// NICE평가정보에서 발급한 IPIN 서비스 사이트패스워드
...
<script type="text/javascript">
    ...
    %>
        ...
        var parameterMap = {
            ...
            ageCode : "<%=sAgeCode%>",
            vNumber : "<%=sVNumber%>",
            genderCode : "<%=sGenderCode%>",
            nationalInfo : "<%=sNationalInfo%>",
            cpRequestNum : "<%=sCPRequestNum%>",
